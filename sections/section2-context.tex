...
The first MCMC technique to be introduced was the Metropolis-Hastings (MH) algorithm, which we will present briefly as it includes key concepts that are also present in other MCMC techniques, while being rather simple.
\todo[inline]{add reference to MH paper}
