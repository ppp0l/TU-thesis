...
Thanks to its adaptivity, the DIME move is able to explore the parameter space efficiently and to sample efficiently from multimodal distributions without sacrificing the efficiency of the sampling process on unimodal distributions.
