...
\end{center}
\caption{Convergence rates for the LR expected error over computational budget for the four considered strategies on the 6d example. The computational budget axis was truncated at 3500 as the budget spent by \texttt{ALR} far exceeds the ones from other strategies. }
    \label{fig:6dLRconv}
\end{figure}
...
Second, we can notice that while the mean and median values achieved by \texttt{randGP} are on par with the other adaptive strategies, there is a considerably high maximum value for the error on the MAP and mean estimates.
...
\begin{table}
    ...
    \toprule
        ...
        \midrule
        \texttt{AGP}
        & 0.0137 & 0.0067 & 0.0029 & 0.0843
        & 0.0192 & 0.0036 & 0.0016 & 0.2334
        & 0.0914 & 0.0795 & 0.0349 & 0.1400 \\
        \texttt{posAdGP}
        & 0.0258 & 0.0156 & 0.0027 & 0.1117
        & 0.0256 & 0.0114 & 0.0013 & 0.1783
        & 0.0868 & 0.0791 & 0.0566 & 0.1383 \\
        \texttt{randGP}
        & 0.0451 & 0.0113 & 0.0030 &  0.314
        & 0.0341 & 0.0062 & 0.0031 & 0.3378
        & 0.0982 & 0.0789 & 0.0336 & 0.1860 \\
        \texttt{LHSGP}
        & 0.3347 & 0.3019 & 0.1498 & 0.8805 
        & 0.2594 & 0.2439 & 0.0854 & 0.4684
        & 0.1300 & 0.1248 & 0.0226 & 0.3528 \\
        \texttt{ALR}
        & 0.0186 & 0.0180 & 0.0041 & 0.0446
        & 0.0113 & 0.0102 & 0.0043 & 0.0272
        & 0.0094 & 0.0087 & 0.0024 & 0.0196 \\
        ...
        & 0.0103 & 0.0095 & 0.0049 & 0.0208 \\
        \texttt{randLR}
        & 0.5498 & 0.5437 & 0.3975 & 0.7604
        & 0.5501 & 0.5328 & 0.3867 & 0.7746
        & 0.0452 & 0.0371 & 0.0167 & 0.1089\\
        \texttt{LHSLR}
