...
\begin{table}[H]
    ...
    \toprule
        ...
        & 0.1486 & 0.0131 & 0.0088 & 0.0331 \\
        \texttt{ALR}
        & 0.0186 & 0.0180 & 0.0041 & 0.0446
        & 0.0113 & 0.0010 & 0.0043 & 0.0272
...
We can notice that the LHS-based strategies \texttt{LHSGP} and \texttt{LHSLR} are the ones obtaining the most performance difference between the two surrogate kinds. 
